...
import ReCU
from ReCU.imagenet.models_imagenet.resnet_ import resnet34_1w1a
class GeM(nn.Module):
    # GeM zhedong zheng
...
class Resnet(nn.Module):
    ...
    def __init__(self, stride=2, init_model=None, pool='avg', pretrained=True):
        ...
        model_ft = resnet34_1w1a()
        checkpoint = torch.load("recunet34.pth.tar", map_location=torch.device('cpu'))
